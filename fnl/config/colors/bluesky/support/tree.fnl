...
(blush (NvimTreeRootFolder :fg cp.almostwhite) (NvimTreeNormal :bg cp.blacker)
       (NvimTreeNormalNC :bg cp.blacker) (NvimTreeVertSplit :bg cp.blacker)
       (NvimTreeFolderIcon :fg cp.blue) (NvimTreeIndentMarker :fg cp.grey)
